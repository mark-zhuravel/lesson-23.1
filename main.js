...
class CalorieCalculator {
    ...
    addProduct(productName, howManyCalories) {
      this.products.set(productName, howManyCalories)
    }
  ...
  calorieCalculator.addProduct('Apple', 52)
  calorieCalculator.addProduct('Banana', 89)
  calorieCalculator.addProduct('Orange', 47)
   
  console.log(calorieCalculator.getProductCalories('Apple')) // 52
  console.log(calorieCalculator.getProductCalories('Banana')) // 89
  console.log(calorieCalculator.getProductCalories('Orange')) // 47
...
uniqueUsernames.addUser('mark_zhuravel')
